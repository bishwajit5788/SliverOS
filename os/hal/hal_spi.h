/**
 * @file hal_spi.h
 * @brief Master SPI bus driver HAL for cooperative display transfers.
 */
#ifndef MK_HAL_SPI_H
#define MK_HAL_SPI_H
...
/* Queue a transfer and return without waiting for the peripheral. */
...
/* Reap completed DMA transactions; bounded and non-blocking. */
